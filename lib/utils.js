...
exports.withTracing = exports.generateSpanContext = exports.isPromise = exports.getSentryInstance = exports.registerSentryInstance = void 0;
...
const generateSpanContext = (metadata, options) => {
    ...
    const description = (options === null || options === void 0 ? void 0 : options.description) || `${functionNameString}${argumentsStringList} call`;
    const descriptionNoArguments = (options === null || options === void 0 ? void 0 : options.description) || `${functionNameString}() call`;
    return {
        op,
        description,
...
const withTracing = (traceparentData, overrides = {}) => (functionToCall) => async (...args) => {
    ...
    const extractedTraceparentData = (0, tracing_1.extractTraceparentData)(traceparentData);
    const className = functionToCall.constructor.name;
    const methodName = functionToCall.name;
    const { op, description } = (0, exports.generateSpanContext)({
        className,
        methodName,
        args,
    });
